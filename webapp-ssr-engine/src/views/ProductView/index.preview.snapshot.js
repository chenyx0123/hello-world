...
export default {
  title: "📷/views/ProductView/index.preview",
  ...
  shop: {
    ...
    products: [
      ...
      },
      {
        ...
        price_text: "92",
        main_image:
          "https://market-static.flyingmilktea.com/%E8%8B%A6%E8%8B%A6/product-image/8c7490a7-f429-41d4-8271-22cc0c6c13fe.jpg",
        sale_price: null,
        regular_price: 92,
        type: "simple",
        stock_status: "instock",
...
const Template = () => <ProductView product={product} preview />;
