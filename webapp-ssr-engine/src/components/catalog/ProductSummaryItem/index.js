  ...
  return (
    ...
    >
      ...
      >
        <Link href={APP_ROUTES.PRODUCT(item.id)} passHref>
          <MuiLink underline="none" sx={{ flexGrow: 1 }}>
            <Typography
              ...
              noWrap
              variant="subtitle1"
              sx={{ textOverflow: "ellipsis", fontWeight: 600 }}
            >
              {item.name}
            </Typography>
            <Typography
        ...
        <Typography color="secondary" underline="none" variant="caption">
          {item.price_text} 珍珠
        </Typography>
        <Typography color="grey.500" underline="none" variant="caption">
